...
module.exports =  {
  ...
  try{
    ...
    // var txCount = await this.web3.getTransactionCount(addressFrom);
   ...
   var addressTo = this.tokenContract.options.address;
    ...
    // var txData = this.web3.abi.encodeFunctionCall({
            name: 'mint',
            type: 'function',
            inputs: [{
                type: 'uint256',
    ...
    var gas_price_wei = this.gas_price_gwei;
    // var max_gas_cost = 1704624;
    var max_gas_cost = 1050000000;
